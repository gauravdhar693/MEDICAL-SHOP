...
{
    public static String CS = ConfigurationManager.ConnectionStrings["MEDLifeDB"].ConnectionString;
    ...
    protected void btnAdd_Click1(object sender, EventArgs e)
    {
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            {
                cmd.Parameters.AddWithValue("@10DayRet", 1.ToString());
            }
            else
            {
                cmd.Parameters.AddWithValue("@10DayRet", 0.ToString());
            }

            ...
            <div class ="form-horizontal">
                ...
                <div class ="form-group">
                    ...
                    <div class ="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorNewPass"  CssClass ="Text-danger" runat="server" ErrorMessage="Enter Your Password" ControlToValidate="txtNewPass"></asp:RequiredFieldValidator>
                  ...
                  <div class ="form-group">
                    ...
                    <div class ="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorConfirmPass"  CssClass ="Text-danger" runat="server" ErrorMessage="Confirm   Coinfirm New " ControlToValidate="txtConfirmPass"></asp:RequiredFieldValidator>
                        <%--<asp:CompareValidator ID="CompareValidatorPass" runat="server" ErrorMessage="CompareValidator"></asp:CompareValidator>--%>
                    </div>
                    </div>
                    <div class ="form-group">
